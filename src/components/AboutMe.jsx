                    ...
                    <div className="flex mb-3 justify-center items-center font-sans bg-black/5 lg:w-[70%]">
                        <div className="content px-4 text-sm  p-2 flex flex-col justify-start gap-2">
                            ...
                            <div className="flex flex-col justify-between lg:items-start gap-2">
                                ...
                                <Link to="https://hungryman.netlify.app/aboutme"><button className=" bg-green-500 rounded-lg p-2 lg:text-xl font-semibold px-4">Live link</button></Link>
                                <Link to="https://github.com/aquamon/Hungryman"><button className="bg-green-500 rounded-lg p-2 lg:text-xl font-semibold px-4">Github link</button></Link>
